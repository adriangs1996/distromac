...
// ║  "Every keystroke ripples through the ocean depths"                          ║
// ╚══════════════════════════════════════════════════════════════════════════════╝
...
// ═══════════════════════════════════════════════════════════════════════════
// AURORA DEPTHS - Emerald Edition Color Palette (Muted/Soft)
// ═══════════════════════════════════════════════════════════════════════════
// Primary: emerald (#3eb489)  → Soft bioluminescent glow, main trail
// Accent:  cyan (#5aafcc)     → Muted ocean pulse, outer edge
// Alt:     jade (#2a9d6e)     → Deep sea shimmer (optional)
// ═══════════════════════════════════════════════════════════════════════════

// Main trail color - Aurora emerald (soft bioluminescent glow)
const vec4 TRAIL_COLOR = vec4(0.243, 0.706, 0.537, 1.0);        // #3eb489

// Accent color - Aurora cyan (muted ocean pulse edge)
const vec4 TRAIL_COLOR_ACCENT = vec4(0.353, 0.686, 0.800, 1.0); // #5aafcc

// Animation timing
const float DURATION = 0.15; // Fast and fluid like ocean currents
